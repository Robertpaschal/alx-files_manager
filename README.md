...
+ `POST /files` => `FilesController.postUpload`<br/>

Inside `controllers`, add a file `FilesController.js` that contains the new endpoint:<br/>

`POST /files` should create a new file in DB and in disk:<br/>
...
+ [x] **6. Get and list file**<br/>
`mandatory`<br/>
In the file `routes/index.js`, add 2 new endpoints:

+ `GET /files/:id` => `FilesController.getShow`
+ `GET /files` => `FilesController.getIndex`<br/>
In the file `controllers/FilesController.js`, add the 2 new endpoints:<br/>
...
+ Otherwise, return the file document<br/>
...
+ [x] **7. File publish/unpublish**<br/>
`mandatory`<br/>
In the file `routes/index.js`, add 2 new endpoints:

+ `PUT /files/:id/publish` => `FilesController.putPublish`
+ `PUT /files/:id/publish` => `FilesController.putUnpublish`<br/>
In the file controllers/FilesController.js, add the 2 new endpoints:<br/>
...
+ `GET /files/:id/data` => `FilesController.getFile`<br/>
In the file `controllers/FilesController.js`, add the new endpoint:<br/>
